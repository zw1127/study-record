...
public class ConsumeModeServiceTest {
    ...
    @Autowired
    @Qualifier("scene5")
    private ConsumeModeService scene5;

    @Autowired
    @Qualifier("scene6")
    private ConsumeModeService scene6;

    @Autowired
    @Qualifier("scene7")
    private ConsumeModeService scene7;

    @Autowired
    @Qualifier("scene8")
    private ConsumeModeService scene8;

    @Autowired
    @Qualifier("scene9")
    private ConsumeModeService scene9;

    @Autowired
    @Qualifier("scene10")
    private ConsumeModeService scene10;

    @Autowired
    @Qualifier("translatorPublishService")
    private ConsumeModeService translatorPublishService;

    @Autowired
    @Qualifier("lambdaService")
    private ConsumeModeService lambdaService;
    ...
    private void testConsumeModeService(ConsumeModeService service,
                                        int eventCount,
                                        int expectEventCount) throws InterruptedException {
