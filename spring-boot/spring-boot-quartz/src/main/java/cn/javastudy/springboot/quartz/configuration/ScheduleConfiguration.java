package cn.javastudy.springboot.quartz.configuration;

import cn.javastudy.springboot.quartz.job.DemoJob01;
import cn.javastudy.springboot.quartz.job.DemoJob02;
...
public class ScheduleConfiguration {
    ...
    public static class DemoJob02Configuration {
        ...
        public Trigger demoJob02Trigger() {
            ...
            CronScheduleBuilder scheduleBuilder = CronScheduleBuilder.cronSchedule("4/5 * * * * ? *");
            // Trigger 构造器
            return TriggerBuilder.newTrigger()
