package cn.javastudy.springboot.simulator.netconf.provider;
...
public class DummyMonitoringService implements NetconfMonitoringService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(DummyMonitoringService.class);
    ...
    private static final Function<Capability, Schema> CAPABILITY_SCHEMA_FUNCTION = capability -> new SchemaBuilder()
        ...
        .setLocation(Set.of(new Schema.Location(Schema.Location.Enumeration.NETCONF)))
