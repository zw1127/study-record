...
## 以下为Redis5.0.5的运行参考配置
### 1. redis-default.conf 作为基础配置,供其他配置文件引用
...
```shell
#导入基础配置include ../redis-default.conf
...
logfile stdout
#数据库访问密码
requirepass AmhEytQUZjqnRSvo7uWkJaM7Vp2jn3rR
#最大连接数 0代表不限制
maxclients 0
...
#集群访问密码,一般和数据库访问密码一致
masterauth AmhEytQUZjqnRSvo7uWkJaM7Vp2jn3rR
```