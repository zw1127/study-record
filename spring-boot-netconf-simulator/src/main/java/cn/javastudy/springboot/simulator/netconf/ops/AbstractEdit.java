...
abstract class AbstractEdit extends AbstractConfigOperation {
    ...
    protected final SchemaContextService schemaContextService;

    protected AbstractEdit(final String netconfSessionIdForReporting, final SchemaContextService schemaContextService) {
    ...
    final SchemaTreeInference getSchemaNodeFromNamespace(final String namespace, final XmlElement element)
        ...
        // need the newest one
        final EffectiveModelContext ctx = schemaContextService.getSchemaContext();
    ...
    static XmlElement extractTargetElement(final XmlElement operationElement, final String operationName)
        throws DocumentedException {
